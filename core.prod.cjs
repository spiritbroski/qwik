/**
 * @license
 * @builder.io/qwik 0.23.0-dev20230322225542
...
!function(global, factory) {
    ...
    const version = "0.23.0-dev20230322225542";
    var _a;
    class MockElement {
    ...
    exports.SSRStream = (props, key) => jsx(RenderOnce, {
        ...
        data: "qkssr-po"
    }) ], exports.SkipRender = SkipRender, exports.Slot = props => _jsxC(Virtual, {
        "q:s": ""
    }, 0, props.name ?? ""), exports._IMMUTABLE = _IMMUTABLE, exports._deserializeData = (data, element) => {
